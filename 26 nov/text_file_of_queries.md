####                   **SQL ASSIGNMENT QUESTION(26 nov)**
...
(1, 1001, '2025-11-26', 'Notebook',99.00,  2),

(2, 1002, '2025-11-26', 'Pen Set', 149.50, 3),

(3, 1003, '2025-11-26', 'USB Cable',79.99, 1),

(4, 1004, '2025-11-26', 'Mouse',  599.00, 1),

(5, 1005, '2025-11-26', 'Keyboard',899.00, 1),

(6,1006,'2025-12-23','Pen Set',100.2,2);



insert into Orders values

(7, 1001, '2025-11-26', 'Notebook',99.00,  100),

(8, 1002, '2025-11-26', 'Pen Set', 149.50, 150),

(9, 1003, '2025-11-26', 'USB Cable',79.99, 300),

(10, 1004, '2025-11-26', 'Mouse',  599.00, 1500),

(11, 1005, '2025-11-26', 'Keyboard',899.00, 1000),

(12,1006,'2025-12-23','Pen Set',100.2,800);
...
select \* from customers where custname like 's\_c%e';
...
select custid as customer\_Id,price as Old\_Price,

price + (price \* 0.20) as new\_Price
...
select custid,count(\*) purchased\_count from Orders
